                ...
                <div class="ibox-content" style="border:0">
					<div class="ibox-title" >
                        ...
                        <div class="form-group">
							...
							<div class="col-sm-3">
	                            <button href="#" class="btn btn-white btn-sm">验证编号</button>
                            </div>
                        </div>
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-7">
                                <input type="text" class="form-control" text="身份证正面">
                            </div>
                        </div>
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-7">
								<label class="checkbox-inline">
                                    <input type="radio" value="option1" id="inlineCheckbox1"> 小戎子1箱
								</label>
								<label class="checkbox-inline">
                                    <input type="radio" value="option1" id="inlineCheckbox1"> 大戎子1箱
								</label>
                            </div>
                        </div>
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
	                            <button href="#" class="btn btn-white btn-sm">获取报单中心</button>
                            </div>
                        </div>
						...
						<div class="form-group">
                            ...
                            <div class="col-sm-7">
								<label class="checkbox-inline">
                                    <input type="checkbox" value="option1" id="inlineCheckbox1"> 我已阅读并同意本协议 <a href="#">查看协议</a>
								</label>
                            </div>
                        </div>
