...
<body>
	...
	<div class="sidebar-collapse">
		<ul class="nav" id="side-menu">
			...
			<li class="<?php if (MODULE_NAME == 'Bonus') {echo 'active';} ?>">
				<a href="index.html"><i class="fa fa-columns"></i> <span class="nav-label">奖金管理</span> <span class="fa arrow"></span></a>
				<ul class="nav nav-second-level">
					<li class="<?php if (MODULE_NAME == 'Bonus' && (ACTION_NAME == 'index' || ACTION_NAME == 'info')) {echo 'active';} ?>">
						<a href="__APP__/Bonus/index">奖金明细</a>
					</li>
					<li class="<?php if (MODULE_NAME == 'Bonus' && ACTION_NAME == 'flow') {echo 'active';} ?>">
			...
			<li class="<?php if (MODULE_NAME == 'Finances') {echo 'active';} ?>">
				...
				<ul class="nav nav-second-level">
					<li class="<?php if (MODULE_NAME == 'Finances' && ACTION_NAME == 'cash') {echo 'active';} ?>">
						<a href="__APP__/Finances/cash">提现申请</a>
					</li>
					<li class="<?php if (MODULE_NAME == 'Finances' && ACTION_NAME == 'cash_list') {echo 'active';} ?>">
                ...
                <div class="ibox-content">
					<form class="form-horizontal m-t" id="signupForm" action="">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <span class="help-block">00001[牛牛]</span>
                            </div>
                        </div>
						<div class="form-group">
							<label class="col-sm-3 control-label">*报单币余额:</label>
							<div class="col-sm-6">
								<span class="help-block">12312313</span>
							</div>
						</div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label">*转入用户编号：</label>
                            <div class="col-sm-6">
                                <input id="user_number" name="user_number" class="form-control" type="text">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
								<div class="radio">
                                    <label>
                                        <input name="type" type="radio" checked="checked" value="1" id="optionsRadios1" name="optionsRadios">报单币转报单币</label>
                                </div>
                            </div>
                        </div>
						<div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-sm-6 col-sm-offset-3">
								...
								<button class="btn btn-warning btn-outline" type="reset">重置</button>
