...
<body>
	...
	<div class="sidebar-collapse">
		<ul class="nav" id="side-menu">
			...
			<li class="<?php if (MODULE_NAME == 'Consumers' && ACTION_NAME == 'index') {echo 'active';} ?>">
				<a href="index.html"><i class="fa fa-columns"></i> <span class="nav-label">消费商管理</span> <span class="fa arrow"></span></a>
				<ul class="nav nav-second-level">
					<li class="<?php if (MODULE_NAME == 'Consumers' && ACTION_NAME == 'index') {echo 'active';} ?>">
						<a href="__URL__">修改资料</a>
					</li>
					<li class="<?php if (MODULE_NAME == 'Consumers' && ACTION_NAME == 'index') {echo 'active';} ?>">
						<a href="__URL__">修改密码</a>
					</li>
				</ul>
			</li>
			...
			<li class="<?php if (MODULE_NAME == 'Teams' && ACTION_NAME == 'index') {echo 'active';} ?>">
				...
				<ul class="nav nav-second-level">
					<li class="<?php if (MODULE_NAME == 'Teams' && ACTION_NAME == 'index') {echo 'active';} ?>">
						<a href="__URL__">消费商激活</a>
					</li>
					<li class="<?php if (MODULE_NAME == 'Teams' && ACTION_NAME == 'index') {echo 'active';} ?>">
						<a href="__URL__">注册消费商</a>
					</li>
					<li class="<?php if (MODULE_NAME == 'Teams' && ACTION_NAME == 'index') {echo 'active';} ?>">
						<a href="__URL__">推荐关系</a>
					</li>
					<li class="<?php if (MODULE_NAME == 'Teams' && ACTION_NAME == 'index') {echo 'active';} ?>">
						<a href="__URL__">接点关系</a>
					</li>
				</ul>
			</li>
			...
			<li class="<?php if (MODULE_NAME == 'Finances' && ACTION_NAME == 'index') {echo 'active';} ?>">
				...
				<ul class="nav nav-second-level">
					<li class="<?php if (MODULE_NAME == 'Finances' && ACTION_NAME == 'index') {echo 'active';} ?>">
						<a href="__URL__">提现申请</a>
					</li>
					<li class="<?php if (MODULE_NAME == 'Finances' && ACTION_NAME == 'index') {echo 'active';} ?>">
						<a href="__URL__">提现记录</a>
					</li>
					<li class="<?php if (MODULE_NAME == 'Finances' && ACTION_NAME == 'index') {echo 'active';} ?>">
						<a href="__URL__">消费商转币</a>
					</li>
					<li class="<?php if (MODULE_NAME == 'Finances' && ACTION_NAME == 'index') {echo 'active';} ?>">
						<a href="__URL__">币种转换</a>
					</li>
					<li class="<?php if (MODULE_NAME == 'Finances' && ACTION_NAME == 'index') {echo 'active';} ?>">
						<a href="__URL__">转币记录</a>
					</li>
				</ul>
			</li>
