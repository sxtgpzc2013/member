				...
				<div class="row">
					<div class="col-sm-9 m-b-xs">
						<p>
							...
							<button type="button" class="btn btn-w-m btn-primary">重置密码</button>
							<button type="button" class="btn btn-w-m btn-primary">修改资料</button>
							<button type="button" class="btn btn-w-m btn-primary">设为报单中心</button>
							<button type="button" class="btn btn-w-m btn-primary">修改消费商级别</button>
