				...
				<div class="row">
					<div class="col-sm-9 m-b-xs">
						<p>
							...
							<button type="button" class="btn btn-w-m btn-primary">冻结</button>
							<button type="button" class="btn btn-w-m btn-primary">导出数据</button>
						</p>
					</div>
					<div class="col-sm-3">
						<div class="input-group">
							<input type="text" placeholder="请输入消费商编码" class="input-sm form-control"> <span class="input-group-btn">
                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                <tr>
									...
									<td>2</td>
                                    <td>
										<a class="btn btn-info btn-sm">冻结</a>
										<div class="btn-group">
