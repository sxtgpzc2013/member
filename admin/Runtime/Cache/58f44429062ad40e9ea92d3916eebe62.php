        ...
        <div class="col-lg-12">
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
						<div class="form-group" style="background:#bbbbbb;color:#ffffff">
						...
						<div class="form-group">
							...
							<div class="col-sm-3">
	                            <button href="#" class="btn btn-white btn-sm">重置密码</button>
                            </div>
                        </div>
