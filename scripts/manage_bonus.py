...
def managerbonus():
	...
	if members:
		for member in members:
			member_leftachievement = {}
			member_leftachievement['leftachievement'] = member['leftachievement']
			member_leftachievement['middleachievement'] = member['middleachievement']
			member_leftachievement['rightachievement'] = member['rightachievement']

			print member_leftachievement
